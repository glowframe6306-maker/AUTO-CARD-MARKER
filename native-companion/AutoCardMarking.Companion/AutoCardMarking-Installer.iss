...
[Setup]
SetupIconFile=Resources\AppIcon\Windows\appicon.ico
...
[Files]
Source: "C:\Users\Administrator\AUTO-CARD-MARKING\native-companion\AutoCardMarking.Companion\publish-windows-exe-icon\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs

[Icons]
Name: "{autodesktop}\AUTO CARD MARKING"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\{#MyAppExeName}"; IconIndex: "0"
Name: "{autoprograms}\AUTO CARD MARKING"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\{#MyAppExeName}"; IconIndex: "0"
