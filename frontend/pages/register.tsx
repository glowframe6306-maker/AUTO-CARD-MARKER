...
export default function RegisterPage() {
  ...
  async function handleRegister(e: React.FormEvent<HTMLFormElement>) {
    ...
    const cleanRcStudentId = rcStudentId.trim();
    ...
    if (
      ...
      setRegError("Missing required registration fields.");
      return;
    }
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 py-12">
      <div className="mx-auto flex min-h-[calc(100vh-6rem)] w-full max-w-md items-center justify-center">
        <section className="w-full rounded-[32px] border border-slate-200 bg-white p-10 shadow-xl">
